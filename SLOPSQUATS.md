...
**110 came back DANGER** from pkgtruth; **44** meet the
...
page lists only two kinds of evidence, and withholds the other 66
...
| `mysqljs` | 231 | `mysql` | npm security placeholder |
...
| `icons-material` | 31 | `@mui/icons-material` | npm security placeholder, almost no adoption |
...
| `commander-js` | 10 | `commander` | npm security placeholder, almost no adoption |
...
| `yargs-js` | 4 | `yargs` | npm security placeholder, almost no adoption |
...
| `winston-js` | 1 | `winston` | npm security placeholder, almost no adoption |
...
## B. Deprecated names whose own notice points elsewhere — 9
